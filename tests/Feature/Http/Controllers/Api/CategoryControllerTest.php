...
class CategoryControllerTest extends TestCase
{
    ...
    public function testUpdate() {
        $this->category = factory(Category::class)->create(['description' => 'description', 'is_active' => false]);
    ...
    public function testDestroy() {
        $response = $this->json('DELETE', route('categories.update', ['category' => $this->category->id]), []);                
